...
- Direct origin: `https://iqpod.tradegpt.ai`
- Worker service: `starpod`
- Source repository: `N9ALV/starpod`
- Canonical route owner: `N9ALV/iq-app-router`
- Member identity and access owner: `N9ALV/IU-Members-subsite`
...
6. Verify both the direct origin and `https://iu.com.au/iq/app/iqpod` in a logged-in member browser.
